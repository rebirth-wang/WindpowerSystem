<template>
  <div class="flow-product-execute">
    <el-form :model="curNode.data" label-width="68px" size="small">
      ...
      <el-form-item :label="$t('ruleengine.editor.components.form.flow-product-execute.807357-0')">
        <el-select
          style="width: 100%"
          ...
          >
            ...
            <span style="float: right">
              <el-tag type="info" v-if="item.status == 1">
                {{ $t('ruleengine.editor.components.form.flow-product-execute.807357-1') }}
              </el-tag>
              <el-tag type="success" v-if="item.status == 2">
                {{ $t('ruleengine.editor.components.form.flow-product-execute.807357-2') }}
              </el-tag>
            </span>
          </el-option>
        </el-select>
      </el-form-item>
      <el-form-item :label="$t('ruleengine.editor.components.form.flow-product-execute.807357-3')">
        <el-select
          style="width: 100%"
      ...
      <el-form-item
        :label="$t('ruleengine.editor.components.form.flow-product-execute.807357-4')"
      ...
      <el-form-item
        :label="$t('ruleengine.editor.components.form.flow-product-execute.807357-5')"
...
const handleModelChange = (val: any) => {
  ...
  curNode.value.data = { ...curNode.value.data, value: 0 };
};
