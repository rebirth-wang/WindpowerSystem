  ...
  <div class="go-edit-bottom">
    ...
    <n-space class="bottom-ri">
      ...
      <n-tooltip trigger="hover">
        ...
        <span>{{ lockScale ? t('visualBigScreen.management-674210-72') : t('visualBigScreen.management-674210-73') }}{{ t('visualBigScreen.management-674210-74') }}</span>
      </n-tooltip>
...
let filterOptions = [
  ...
  {
    label: t('visualBigScreen.management-674210-681'),
    value: 0
  }
]
