...
import { ToolsStatusEnum } from '@vb/store/modules/settingStore/settingStore.d'
...
import { EditEnum } from '@vb/enums/pageEnum'
...
// 编辑处理
const editHandle = () => {
  ElMessage.warning(t('visualBigScreen.management-674210-1099'))
...
const btnList: BtnListType[] = [
  {
    ...
    name: t('visualBigScreen.management-674210-1100'),
    icon: ShareIcon
  },
  {
    key: 'export',
    type: TypeEnum.BUTTON,
    name: t('visualBigScreen.management-674210-1101'),
    icon: DownloadIcon,
    handle: exportHandle
  },
  {
    key: 'edit',
    type: TypeEnum.BUTTON,
    name: t('visualBigScreen.management-674210-4'),
    icon: CreateIcon,
    handle: editHandle
  },
  {
    key: 'setting',
    type: TypeEnum.BUTTON,
    name: t('visualBigScreen.management-674210-949'),
