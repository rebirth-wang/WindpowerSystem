...
import { getKeyboardActive, onSpacePressHold } from '@vb/utils/runtimeContext'
...
let removeSpacePressHoldListener: (() => void) | null = null
...
const dragCanvas = (e: any) => {
  ...
  else if (!getKeyboardActive().space) return
  // @ts-ignore
...
onMounted(() => {
  ...
  removeSpacePressHoldListener = onSpacePressHold((isHold: boolean) => {
...
onUnmounted(() => {
  ...
  removeSpacePressHoldListener?.()
  removeSpacePressHoldListener = null
})
</script>
