...
import { MouseEventButton } from '@vb/enums/editPageEnum'
...
import { useContextMenu, divider } from '@vb/views/chart/hooks/useContextMenu.hook'
import { MenuOptionsItemType } from '@vb/views/chart/hooks/useContextMenu.hook.d'
import { LayerModeEnum } from '@vb/store/modules/chartLayoutStore/chartLayoutStore.d'
...
const clickHandle = (e: MouseEvent) => {
  // 按下左键 + CTRL
  if (getKeyboardActive().ctrl) return
  // 判断左右键
