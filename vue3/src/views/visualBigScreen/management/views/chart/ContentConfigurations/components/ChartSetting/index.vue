...
import NameSetting from '@vb/components/Pages/ChartItemSetting/NameSetting.vue'
import PositionSetting from '@vb/components/Pages/ChartItemSetting/PositionSetting.vue'
import SizeSetting from '@vb/components/Pages/ChartItemSetting/SizeSetting.vue'
...
.go-chart-configurations-setting {
}
</style>
