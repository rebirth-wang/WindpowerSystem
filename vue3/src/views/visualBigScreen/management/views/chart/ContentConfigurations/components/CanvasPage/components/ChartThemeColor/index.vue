  ...
  <div class="go-chart-theme-color">
    <n-card class="card-box" size="small" hoverable embedded @click="createColorHandle">
      <n-text class="go-flex-items-center">
        <span>{{ t('visualBigScreen.management-674210-69') }}</span>
        <n-icon size="16">
          <add-icon></add-icon>
        </n-icon>
      </n-text>
...
import { ChartColorsNameType } from '@vb/settings/chartThemes/index'
import { useDesignStore } from '@vb/store/modules/designStore/designStore'
import { loadAsyncComponent, colorCustomMerge } from '@vb/utils'
