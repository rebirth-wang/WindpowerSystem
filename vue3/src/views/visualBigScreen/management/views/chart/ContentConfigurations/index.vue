...
const globalTabList = [
  {
    ...
    title: t('visualBigScreen.management-674210-1074'),
...
const chartsDefaultTabList = [
  {
    ...
    title: t('visualBigScreen.management-674210-1075'),
    icon: ConstructIcon,
    render: ChartSetting
  },
  {
    key: TabsEnum.CHART_ANIMATION,
    title: t('visualBigScreen.management-674210-158'),
    icon: LeafIcon,
...
const chartsTabList = [
  ...
  },
  {
    ...
    title: t('visualBigScreen.management-674210-1076'),
    icon: RocketIcon,
    render: ChartEvent
  }
]
