...
export enum ChartEnum {
  // 图表创建
  CHART_HOME = '/visual/chart/home/:id(.*)*',
  CHART_HOME_NAME = 'VisualChartHome',
}

export enum PreviewEnum {
  //  图表预览
  CHART_PREVIEW = '/visual/chart/preview/:id(.*)*',
  CHART_PREVIEW_NAME = 'VisualChartPreview',
}

export enum EditEnum {
  //  图表JSON编辑
  CHART_EDIT = '/visual/chart/edit/:id(.*)*',
  CHART_EDIT_NAME = 'VisualChartEdit',
}
