...
export const SelectHttpTimeNameObj = {
  [RequestHttpIntervalEnum.SECOND]: i18n.global.t('visualBigScreen.management-674210-429'),
  [RequestHttpIntervalEnum.MINUTE]: i18n.global.t('visualBigScreen.management-674210-428'),
  [RequestHttpIntervalEnum.HOUR]: i18n.global.t('visualBigScreen.management-674210-427'),
  [RequestHttpIntervalEnum.DAY]: i18n.global.t('visualBigScreen.management-674210-423')
}
