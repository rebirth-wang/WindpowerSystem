...
import { CreateComponentType, ChartFrameEnum } from '@vb/packages/index.d'
...
import { isPreview, newFunctionHandle, intervalUnitHandle } from '@vb/utils'
import { setOption } from '@vb/packages/public/chart'
