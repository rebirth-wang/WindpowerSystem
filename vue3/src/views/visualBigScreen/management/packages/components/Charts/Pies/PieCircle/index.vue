...
import { mergeTheme } from '@vb/packages/public/chart'
...
const dataHandle = (newData: any) => {
  ...
  props.chartConfig.option.title.text = `${+d.toFixed(2)}%`
  props.chartConfig.option.series[0].data[0].value[0] = d
  props.chartConfig.option.series[0].data[1].value[0] = 100 - d
