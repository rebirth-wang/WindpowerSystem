<template>
  <CollapseItem :name="t('visualBigScreen.management-674210-242')" :expanded="true">
    <SettingItemBox :name="t('visualBigScreen.management-674210-457')">
      <SettingItem>
        <n-space>
          <n-switch v-model:value="optionData.reverse" size="small" />
          <n-text>{{ t('visualBigScreen.management-674210-950') }}</n-text>
        </n-space>
      </SettingItem>
    </SettingItemBox>
