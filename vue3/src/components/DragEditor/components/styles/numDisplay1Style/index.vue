<template>
  <section class="num-display-1-style">
    <el-form class="style-form" label-width="80px" :model="datas" size="small">
    ...
    <attribute-selector :data="selectFeature" type="numDisplay1Style"></attribute-selector>
    <icon-panel
      v-if="icon !== ''"
      :data="selectIcon"
      :icon="icon"
...
defineOptions({ name: 'NumDisplay1Style' });
