<template>
  <section class="btn-control-1-style">
    <el-form label-width="80px" :model="datas" size="small">
      ...
      <el-form-item :label="$t('components.DragEditor.rightslider.756540-63')">
        <el-radio-group v-model="datas.setStyle.model">
          <el-radio :label="1">{{ $t('components.DragEditor.rightslider.756540-64') }}</el-radio>
          <el-radio :label="2">{{ $t('components.DragEditor.rightslider.756540-65') }}</el-radio>
        </el-radio-group>
      </el-form-item>
      ...
      <el-form-item :label="$t('components.DragEditor.rightslider.756540-66')" class="between">
        <el-color-picker
          v-model="datas.setStyle.btnColor"
          show-alpha
          class="picke"
          :predefine="predefineColors"
        ></el-color-picker>
    ...
    <attribute-selector :data="selectFeature" type="btnControl1Style"></attribute-selector>
  </section>
</template>
...
defineOptions({ name: 'btnControl1Style' });
