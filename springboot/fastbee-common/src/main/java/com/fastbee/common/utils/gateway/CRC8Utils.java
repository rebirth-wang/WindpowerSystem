...
public class CRC8Utils {
    ...
    public static void main(String[] args) {
        String var1 = "333701120008C100";
        byte[] var2 = ByteUtils.hexToByte(var1);
        byte var3 = calcCrc8_E5(var2);
        System.out.println("" + Integer.toHexString(255 & var3));
    }
}
