...
public class RecordController extends BaseController {
    ...
    @ApiOperation("通过文件名查询服务端录像列表")
    @PreAuthorize("@ss.hasPermi('iot:sip:record:list')")
    @GetMapping("/serverRecord/channel/list")
    public AjaxResult listServerRecordByChanelId(@RequestParam Integer pageNum, @RequestParam Integer pageSize,
                                                 @RequestParam String serverId, @RequestParam String channelId,
                                                 @RequestParam String startTime, @RequestParam String endTime) {
        return AjaxResult.success("success!", recordService.listServerRecordByChanelId(serverId, channelId, startTime, endTime, pageNum, pageSize));
    }
