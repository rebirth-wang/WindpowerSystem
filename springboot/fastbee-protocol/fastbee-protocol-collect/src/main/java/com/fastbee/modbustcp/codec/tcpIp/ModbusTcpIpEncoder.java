...
import static com.fastbee.common.extend.core.protocol.modbus.ModbusCode.getInstance;
...
@Component
@NoArgsConstructor
public class ModbusTcpIpEncoder {
    ...
    public ModbusTcpIpEncoder(String... basePackages) {
    ...
    public ByteBuf encode(ModbusTcp message) {
        ...
        RuntimeSchema runtimeSchema = headerSchemaMap.get(version);
        runtimeSchema.writeTo(buf, message, null);
        return buf;
    }
