...
public class MultiPacket {
    ...
    private final JT808Message firstPacket;
    ...
    public MultiPacket(JT808Message firstPacket) {
    ...
    public JT808Message getFirstPacket() {
        return firstPacket;
    }
    ...
    public String toString() {
        ...
        sb.append(", cid=").append(firstPacket.getSerialNumber());
