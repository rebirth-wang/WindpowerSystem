...
public interface NotifySendService {
    ...
    /**
     * 工单通知统一推送
     * @param workOrderNotifyParams 工单推送参数
     * @return void
     */
    String workOrderSend(WorkOrderNotifyParams workOrderNotifyParams);
    ...
    /**
     * 报表通知统一推送
     * @param reportNotifyParams 报表推送参数
     * @return void
     */
    String reportSend(ReportNotifyParams reportNotifyParams);
