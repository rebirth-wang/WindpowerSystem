...
public class DeviceCacheService {
     ...
     * 设备ID -> Device对象的映射
     */
    private final Map<String, IsupDevInfo> deviceMap = new ConcurrentHashMap<>();
     ...
     * @param device 设备对象
     */
    public void saveOrUpdate(IsupDevInfo device) {
     ...
     */
    public Optional<IsupDevInfo> getByDeviceId(String deviceId) {
     ...
     * @return 设备对象
     */
    public Optional<IsupDevInfo> getByLoginId(Integer loginId) {
     ...
     * @return 所有设备列表
     */
    public List<IsupDevInfo> listAll() {
     ...
     * @return 符合条件的设备列表
     */
    public List<IsupDevInfo> list(Predicate<IsupDevInfo> predicate) {
    ...
    public void removeByDeviceId(String deviceId) {
        IsupDevInfo device = deviceMap.remove(deviceId);
        if (device != null) {
            // 移除loginId映射
