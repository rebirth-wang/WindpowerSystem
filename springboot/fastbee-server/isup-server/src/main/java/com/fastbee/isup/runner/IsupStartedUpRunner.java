package com.fastbee.isup.runner;
...
import com.fastbee.isup.sdk.service.impl.FPREVIEW_NEWLINK_CB_FILE;
import com.fastbee.isup.sdk.service.impl.FRegisterCallBack;
...
@Profile("isup")
public class IsupStartedUpRunner implements ApplicationRunner, DisposableBean {
...
//    private final VOICETALK_NEWLINK_CB voiceCallBack;
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        System.arraycopy(hikIsupProperties.getListenIp().getBytes(), 0, netEhomeListenPreviewCfg.struIPAdress.szIP, 0, hikIsupProperties.getListenIp().length());
        netEhomeListenPreviewCfg.struIPAdress.wPort = Short.parseShort(hikIsupProperties.getSmsPort()); //流媒体服务器监听端口
        ...
        System.arraycopy(hikIsupProperties.getListenIp().getBytes(), 0, struCMSListenPara.struAddress.szIP, 0, hikIsupProperties.getListenIp().length());
        struCMSListenPara.struAddress.wPort = Short.parseShort(hikIsupProperties.getCmsPort());
        ...
        System.arraycopy(hikIsupProperties.getListenIp().getBytes(),
                0, net_ehome_alarm_listen_param.struAddress.szIP,
                0, hikIsupProperties.getListenIp().length());
        ...
        System.arraycopy(hikIsupProperties.getListenIp().getBytes(), 0, struPlayBackListen.struIPAdress.szIP, 0, hikIsupProperties.getListenIp().length());
        struPlayBackListen.struIPAdress.wPort = Short.parseShort(hikIsupProperties.getSmsBackPort()); //流媒体服务器监听端口
        ...
        String ServerIP = hikIsupProperties.getExtendIp();
        System.arraycopy(ServerIP.getBytes(), 0, ipaddress.szIP, 0, ServerIP.length());
        ipaddress.wPort = Short.parseShort(hikIsupProperties.getPicServer().getListenPort());
        ipaddress.write();
        ...
        String SSIP = hikIsupProperties.getListenIp();
