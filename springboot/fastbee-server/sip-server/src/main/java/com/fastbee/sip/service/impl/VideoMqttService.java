...
public class VideoMqttService implements IMqttService {
    ...
    public void publishInfo(SipDevice device) {
        ...
        if (null != sipConfig) {
            ...
            deviceUpdateService.updateDevice(iotdevice);
    ...
    @Override
    public void publishChannelsProperty(String DeviceId, List<CommonChannel> channels) {
        ...
        if (null != sipConfig) {
            ...
            thingsList.add(item);
            publishProperty(sipConfig.getProductId(), DeviceId, thingsList, 0);
        }
    }
