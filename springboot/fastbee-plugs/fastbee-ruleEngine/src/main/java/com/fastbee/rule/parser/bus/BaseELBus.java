...
import com.fastbee.rule.parser.entity.node.NodeDataBase;
import com.fastbee.rule.parser.entity.node.NodeDataLoop;
...
public class BaseELBus {
    ...
    protected static ELWrapper buildNode(Node node) throws LiteFlowELException {
        ...
        switch (type) {
            case "script":
                return ELBusNode.scriptNode(node);
            case "common":
