package com.fastbee.social.wechat.impl;
...
import static com.fastbee.common.extend.utils.SecurityUtils.getUserId;
import static com.fastbee.social.service.impl.SocialLoginServiceImpl.LOGIN_ERROR_MSG_REDIS_KEY;
import static com.fastbee.social.service.impl.SocialLoginServiceImpl.WX_BIND_REDIS_KEY;
...
import com.fastbee.common.extend.utils.WechatUtils;
import com.fastbee.common.extend.wechat.*;
...
import com.fastbee.social.model.login.WeChatLoginQrRes;
import com.fastbee.social.service.ISocialLoginService;
import com.fastbee.social.service.ISocialPlatformService;
import com.fastbee.social.service.ISocialUserService;
import com.fastbee.social.wechat.WeChatService;
import com.fastbee.social.wechat.vo.WxBindReqVO;
import com.fastbee.social.wechat.vo.WxCancelBindReqVO;
...
//            }
            ...
            setLoginToken(weChatLoginResult, token);
        }
    ...
    public WeChatLoginResult miniLogin(WeChatLoginBody weChatLoginBody, String language) {
        ...
        if (sysUser == null) {
            ...
            RegisterUserOutput registerUserOutput = socialUserService.registerNoCaptcha(registerUserInput);
...
//            }
    ...
    private void setLoginToken(WeChatLoginResult weChatLoginResult, String token) {
        weChatLoginResult.setToken(token);
        weChatLoginResult.setExpireTime(sysLoginService.getTokenExpireTime(token));
    }
