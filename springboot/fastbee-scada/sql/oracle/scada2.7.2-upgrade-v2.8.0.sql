...
ALTER TABLE "scada_echart" ADD "sys_flag" NUMBER(1) DEFAULT 0;
...
ALTER TABLE "scada_component" ADD "sys_flag" NUMBER(1) DEFAULT 0;
...
ALTER TABLE "scada_model" ADD "sys_flag" NUMBER(1) DEFAULT 0;
