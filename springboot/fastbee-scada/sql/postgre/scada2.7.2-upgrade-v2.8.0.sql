...
ALTER TABLE "scada_echart" ADD COLUMN "sys_flag" int4 DEFAULT 0;
...
ALTER TABLE "scada_component" ADD COLUMN "sys_flag" int4 DEFAULT 0;
...
ALTER TABLE "scada_model" ADD COLUMN "sys_flag" int4 DEFAULT 0;
