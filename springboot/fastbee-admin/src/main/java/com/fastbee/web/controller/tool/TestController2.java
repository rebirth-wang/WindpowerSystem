...
import com.fastbee.common.extend.core.domin.model.HttpTestVO;
...
//        deviceLog.setOperation(5);
    ...
    @GetMapping("/getHttp")
    public AjaxResult httpGet() {
        return AjaxResult.success();
    }

    @GetMapping("/getHttpParams")
    public AjaxResult getHttpParams(String deviceName, String serialNumber, String address, String alertName, String identify, String value, String alertTime) {
        return AjaxResult.success(deviceName + serialNumber + address + alertName);
    }

    @PostMapping("/postHttpParams")
    public AjaxResult postHttpParams(@RequestParam String deviceName, @RequestParam String serialNumber, @RequestParam String address, @RequestParam String alertName) {
        return AjaxResult.success(deviceName + serialNumber + address + alertName);
    }

    @PostMapping("/postHttpBody")
    public AjaxResult postHttpBody(@RequestBody HttpTestVO vo) {
        return AjaxResult.success(JSON.toJSONString(vo));
    }

    @PutMapping("/putHttpParams")
    public AjaxResult putHttpParams(@RequestParam String deviceName, @RequestParam String serialNumber, @RequestParam String address, @RequestParam String alertName) {
        return AjaxResult.success(deviceName + serialNumber + address + alertName);
    }

    @PutMapping("/putHttpBody")
    public AjaxResult putHttpBody(@RequestBody HttpTestVO vo) {
        return AjaxResult.success(JSON.toJSONString(vo));
    }
