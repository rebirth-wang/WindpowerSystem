...
public class ThingsModel extends BaseEntity{
    ...
    @AiSemanticField(
            ...
            relationHint = "iot_things_model.model_id=ai_model.model_id"
    )
    ...
    @AiSemanticField(
            semanticType = AiSemanticType.RELATION_KEY,
            relationHint = "iot_things_model.product_id=iot_product.product_id;可通过 iot_product.product_id=iot_things_model.product_id 继续关联物模型"
    )
