 ...
 */
@Data
public class JobCronCycleVO {

    public static void main(String[] args) {
        String s = "[{\"day\": \"1\", \"time\": \"00\", \"type\": \"month\", \"toDay\": \"3\", \"toTime\": \"02\", \"toType\": \"4\"}]";
        List<JobCronCycleVO> jobCronCycleVOList = JSON.parseArray(s, JobCronCycleVO.class);
        System.out.println(JSON.toJSONString(jobCronCycleVOList.get(0)));
    }
