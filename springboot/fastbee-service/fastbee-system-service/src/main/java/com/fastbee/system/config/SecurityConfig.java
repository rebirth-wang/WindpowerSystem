package com.fastbee.system.config;
...
import com.fastbee.system.service.sys.filter.JwtAuthenticationTokenFilter;
import com.fastbee.system.service.sys.handle.AuthenticationEntryPointImpl;
import com.fastbee.system.service.sys.handle.LogoutSuccessHandlerImpl;
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests((requests) -> {
                    ...
                    String[] permitAllPaths = {
                            ...
                            "/dueros", "/license/**", "/httptest/**", "/ruleview/**", "/error"
                    };

                    // 静态资源路径单独列出，确保仅限GET方法且限定特定类型文件
                    String[] staticResourcePaths = {
                            "/", "/*.html", "/**/*.html", "/**/*.css", "/**/*.js", "/profile/**"
                    };

                    // Swagger & Druid 开发工具相关路径
                    String[] devToolPaths = {
                    ...
                    requests.dispatcherTypeMatchers(DispatcherType.ASYNC, DispatcherType.ERROR).permitAll()
                            ...
                            .requestMatchers(HttpMethod.GET, staticResourcePaths).permitAll()
                            .requestMatchers(devToolPaths).permitAll()
