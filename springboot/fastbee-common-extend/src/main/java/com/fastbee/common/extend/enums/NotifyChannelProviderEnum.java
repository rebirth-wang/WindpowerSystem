...
import com.fastbee.common.extend.core.domin.notify.config.*;
import com.fastbee.common.extend.core.domin.notify.msg.*;
...
public enum NotifyChannelProviderEnum {
    ...
    WECHAT_SERVICE_ACCOUNT("wechat", "service_account", "微信服务号", WeChatConfigParams.class, WechatMsgParams.class),
    ...
    /***** HTTP *****/
    HTTP_PUBLIC("http", "http", "公共HTTP", null, HttpMsgParams.class);
...
//                break;
     ...
     * @return: java.lang.Object
     */
    public static List<NotifyConfigVO> getMsgParams(NotifyChannelProviderEnum type, String msgType, String method) {
        List<NotifyConfigVO> configVOList = new ArrayList<>();
        switch (type) {
...
//                configVOList.add(new NotifyConfigVO("title", "标题", "string",""));
            ...
            case HTTP_PUBLIC:
                ...
                configVOList.add(new NotifyConfigVO("hostUrl", "请求地址", "string",""));
                configVOList.add(new NotifyConfigVO("requestHeaders", "请求头", "string",""));
                configVOList.add(new NotifyConfigVO("requestParams", "请求参数", "string",""));
                if ("post".equals(method) || "put".equals(method)) {
                    configVOList.add(new NotifyConfigVO("requestBody", "请求体", "string",""));
                }
            default:
                return configVOList;
        }
