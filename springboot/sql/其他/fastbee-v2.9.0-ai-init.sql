...
VALUES
(@ai_menu_parent, 'AI赋能', 0, 13, 'ai', NULL, '', 1, 0, 'M', '0', 0, '', 'guide', 'admin', NOW(), '', NULL, 'AI赋能目录', 0),
...
(@ai_protocol_adaptation_menu, '协议适配', @ai_menu_parent, 6, 'protocolAdaptation', 'ai/protocolAdaptation/index', '', 1, 0, 'C', '0', 0, 'ai:protocol:adaptation:list', 'connection', 'admin', NOW(), '', NULL, 'AI协议适配任务菜单', 0);
